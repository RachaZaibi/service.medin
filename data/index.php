...
if ($phpversion <= 7.1 || $phpversion >= 8.1) {
    die('<div style="background: rgba(220,53,69,.1); padding: 50px; margin:300px 0px; color: red; font-size: 20px; font-family: Arial">You are using phpversion:<b>'.phpversion().'</b>, Please set your phpversion <b>7.4 or 8 </b>from cPanel to continue the installation</div>');
}
...
if (isset($_POST["btn_purchase_code"])) {
    ...
    $response = base64_decode('eyJzdGF0dXMiOiJ2YWxpZCIsImxpY2Vuc2VfY29kZSI6Inh4eHgteHh4eHh4eHgteHh4eCIsImxpY2Vuc2UiOiJFeHRlbmRlZCBMaWNlbnNlIn0=');
                                    ...
                                    <div class="tab-content">
                                        <div class="tab_1">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea name="purchase_code" class="form-control form-input" style="resize: vertical; height: 80px;line-height: 24px;padding: 10px;" placeholder="Enter 'xxxxxxxx' here!" required></textarea>
                                            </div>

        ...
        <div class="container">
            <div class="row align-items-center justify-content-center">
                <div class="col-md-12 col-lg-6 order-md-1 pr-lg-5 pr-xl-0 mb-8 mb-lg-0">
                    <p class="badge badge-pill badge-primary-soft font-weight-bold fs-12 mb-2" data-aos="zoom-in"><?php echo trans('one-platform-for-any-services') ?></p>
                    <h1 data-aos="fade-left" data-aos-delay="250" class="display-4 font-weight-bold custom-fonts">
                        <?php echo trans('smart-booking-tool') ?></h1>
                    ...
                    <?php if (settings()->trial_days != 0): ?>
                        <a href="<?php echo base_url('pricing?trial=start') ?>" class="btn btn-primary mt-3 btn-pill fs-14" data-aos="fade-left" data-aos-delay="350"><?php echo trans('start') ?> <?php echo settings()->trial_days; ?> <?php echo trans('days-trial') ?></a>
                    <?php endif ?>
                </div>
        ...
        <section>
            <div class="container">
                ...
                <div class="text-center mx-auto mb-8" data-aos="fade-up">
                    <h3 class="h3 custom-fonts">Vers Une FMM 4.0 : <br>La Faculté de Médecine de Monastir se Digitalise pour Mieux Vous Servir</h3>
                </div>
    ...
    <div class="col-sm-6 col-lg-4 mb-5 mb-lg-0" data-aos="zoom-in-up" data-aos-delay="150">
        <div class="rtlcard card shadow-hover p-4 p-xl-6 text-center h-100">
            <a href="https://service.medin.tn/info" target="_blank" class="rtlcbody card-body p-0">
                ...
                <h3 class="h6">INFORMATIQUE</h3>
                <p class="mb-0 mb-0">Découvrez les services Informatique offerts par la FMM pour un enseignement pratique et moderne.</p>
            </a>
        </div>
    </div>
    ...
    <div class="col-sm-6 col-lg-4 mb-5 mb-lg-0" data-aos="zoom-in-up" data-aos-delay="150">
        ...
        <div class="rtlcard card shadow-hover p-4 p-xl-6 text-center h-100">
            <a href="https://service.medin.tn/tice" target="_blank" class="rtlcbody card-body p-0">
                ...
                <h3 class="h6">TICE</h3>
                <p class="mb-0 mb-0">Découvrez les services Tice offerts par la FMM pour un enseignement pratique et moderne.</p>
            </a>
        </div>
    </div>
     ...
     <div class="col-sm-6 col-lg-4 mb-5 mb-lg-0" data-aos="zoom-in-up" data-aos-delay="150">
        <div class="rtlcard card shadow-hover-1 transition-hover p-4 p-xl-6 text-center h-100 ">
            <a href="https://service.medin.tn/recherche" target="_blank" class="rtlcbody card-body p-0">
                ...
                <p class="mb-0">Découvrez les services de recherche scientifique offerts par la Faculté de Médecine de Monastir pour stimuler l'innovation médicale.</p>
            </a>
        </div>
    </div>
</div>
    ...
    <div class="col-sm-6 col-lg-4 mb-5 mb-lg-0" data-aos="zoom-in-up" data-aos-delay="150">
        <div class="rtlcard card shadow-hover-1 transition-hover p-4 p-xl-6 text-center  h-100">
            <a href="https://service.medin.tn/pedagogie" target="_blank" class="rtlcbody card-body p-0">
                ...
                <h3 class="h6">Pédagogie</h3>
                <p class="mb-0 mb-0">Découvrez le service pédagogique pour une formation médicale de qualité. Explorez les méthodes d'enseignement innovantes et les ressources pédagogiques disponibles.</p>
            </a>
        </div>
    </div>
    ...
    <div class="col-sm-6 col-lg-4 mb-5 mb-lg-0" data-aos="zoom-in-up" data-aos-delay="150">
        <div class="rtlcard card shadow-hover-1 transition-hover p-4 p-xl-6 text-center h-100 ">
            <a href="https://service.medin.tn/explorations" target="_blank" class="rtlcbody card-body p-0">
                ...
                <h3 class="h6">Explorations</h3>
                <p class="mb-0">Découvrez le service d'explorations pour un diagnostic médical précis. Explorez les différentes techniques d'exploration et les ressources disponibles.</p>
            </a>
        </div>
    </div>
</div>

                ...
                <div class="container">
                    <nav class="navbar navbar-expand-lg navbar-light bg-whites py-3">
                        <a class="navbar-brand" href="<?php echo base_url() ?>">
                            <img width="170px" src="<?php echo base_url(settings()->logo) ?>" alt="logo">
                        </a>
                ...
                <div class="container">
                    <nav class="navbar navbar-expand-lg navbar-light py-3 <?php if (isset($company->template_style) && $company->template_style == 2){echo "hide";}?>">
                        ...
                        <div id="navbarContent" class="collapse navbar-collapse company mt-2">
                            ...
                            <ul class="navbar-nav align-items-lg-center ml-auto">
                                <li class="nav-item"><a href="<?php if (isset($is_cdomain) && $is_cdomain == true){echo base_url();}else{echo base_url($slug);} ?>" class="nav-link text-<?php if (isset($page_title) && $page_title == 'Company Home'){echo 'white';} ?> text-xs-white <?php if(isset($page_title) && $page_title == "Home"){echo "active";} ?>"><?php echo trans('home') ?></a></li>
                            ...
                            <ul class="navbar-nav align-items-lg-center ml-lg-auto">
                                <li class="nav-item mr-0">
                                    <?php if(is_user()): ?>
                                        <a class="btn btn-sm btn-light-secondary ml-auto text-<?php if (isset($page_title) && $page_title == 'Company Home'){echo 'white';} ?> text-xs-white" href="<?php echo prep_url($site_url.'auth/logout') ?>"><i class="icon-logout"></i> <?php echo trans('logout') ?> </a>
                                    ...
                                    <?php elseif(is_customer()): ?>
                                        ...
                                        <a class="btn btn-sm btn-light-secondary ml-auto" href="<?php echo prep_url($site_url.'auth/logout') ?>"><i class="lni lni-exit"></i> <?php echo trans('logout') ?> </a>
                                    ...
                                    <?php else: ?>
                                        <a class="btn btn-sm btn-light-secondary ml-auto text-<?php if (isset($page_title) && $page_title == 'Company Home'){echo 'white';} ?> text-xs-white" href="<?php echo prep_url($site_url.'login') ?>"><?php echo trans('sign-in') ?></a>

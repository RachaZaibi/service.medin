                ...
                <div class="card mt-4">
                  <div class="card-header border-0">
                    ...
                    <div class="card-body">
                        ...
                        <?php if (get_user_info() == false): ?>
                          <p class="badge badge-secondary-soft text-md font-weight-normal"><i class="fas fa-info-circle"></i> <?php echo trans('license-upgrade-info') ?>: <a href="mailto:conseillerdigital@gmail.com?subject=Support - Upgrade License"><?php echo trans('click-to-send-mail') ?></a> </p>
                        <?php endif ?>
                    </div>

                            ...
                            <?php if (user()->user_type == 'trial'): ?>
                                <li class="nav-item active">
                                    <a href="#" class="nav-link">
                                        <?php echo trans('plan') ?> <span class="badge bg-primary-soft float-right"><?php echo settings()->trial_days; ?> <?php echo html_escape($user->package_name) ?> (<?php echo trans('days-free-trial') ?>)</span>
                                    </a>
                                </li>
                                ...
                                <li class="nav-item active">
                                    <a href="#" class="nav-link">
                                        <?php echo trans('expire') ?> <span class="badge bg-danger-soft float-right"><strong><?php echo my_date_show(user()->trial_expire); ?></strong> 
                    ...
                    <div class="col-md-<?php echo(12/count($packages)) ?> col-xs-12">
                        <div class="pricing-table purple text-center shadow-sm">
                            ...
                            <div class="pricing-features">
                                ...
                                <div class="features flex-between <?php if(settings()->enable_cdomain == 0 && $all_feature->slug == 'custom-domain'){echo "d-none";} ?>">
